                    ...
                    <div class="admin-control-center">
                        <form action="" class="form-search">
                            ...
                            <input id="form-search-tk" type="text" class="form-search-input"
                                placeholder="Tìm kiếm tên mã, tên khách hàng...">
                        </form>
                    </div>
                    ...
                    <table width="100%">
                        ...
                        <tbody id="showTk">
                            <tr>
                                ...
                                <td>10</td>
                                <td>980.000.000đ</td>
                                <td><button class="btn-detail product-order-detail"><a href="chitietthongkekh.php"><i
                        ...
                        <tbody id="showTk">
                            <tr>
                                ...
                                <td>7</td>
                                <td>960.000.000đ</td>
                                <td><button class="btn-detail product-order-detail"><a href="chitietthongkekh2.php"><i
                                    class="fa-regular fa-eye"></i> Chi tiết</a></button></td>
                            </tr>
                        </tbody>
                        <tbody id="showTk">
                            <tr>
                                ...
                                <td>5</td>
                                <td>840.000.000đ</td>
                                <td><button class="btn-detail product-order-detail"><a href="chitietthongkekh3.php"><i
                                    class="fa-regular fa-eye"></i> Chi tiết</a></button></td>
                            </tr>
                        </tbody>
                        <tbody id="showTk">
                            <tr>
                                ...
                                <td>3</td>
                                <td>560.000.000đ</td>
                                <td><button class="btn-detail product-order-detail"><a href="chitietthongkekh4.php"><i
                                    class="fa-regular fa-eye"></i> Chi tiết</a></button></td>
                            </tr>
                        </tbody>
                        <tbody id="showTk">
                            <tr>
                                ...
                                <td>2</td>
                                <td>490.000.000đ</td>
                                <td><button class="btn-detail product-order-detail"><a href="chitietthongkekh5.php"><i
                                    class="fa-regular fa-eye"></i> Chi tiết</a></button></td>
                            </tr>
                        </tbody>
