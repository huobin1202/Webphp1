        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet12" id="frmsanphamchitiet12" method="post"></form>
                        
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="klx230/k2302.jpg" >
                                <img src="klx230/k2301.jpg" >
                                
                                <img src="klx230/klx230.jpg" >
                            ...
                            <div class="details col-md-6">
                                <div class="card page-2">
                                    <img src="image/klx-230.png" style="width: 1px;" alt="Z 500">
                                    <h3>KLX®230</h3>
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,080 x 825 x 1,165 mm</li>
                                    <li><strong>Chiều cao yên</strong> 885 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 285 mm</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung thép ống, bền bỉ và ổn định</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc ống lồng, đường kính 37mm</li>
                                    <li><strong>Hệ thống treo sau</strong> Giảm xóc monoshock có thể điều chỉnh</li>
                                    <li><strong>Phanh trước</strong> Đĩa đơn 240mm</li>
