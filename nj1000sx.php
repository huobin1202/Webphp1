        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet2" id="frmsanphamchitiet2" method="post"></form>           
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="nj1000sx/nj1000sx1.webp" >
                                <img src="nj1000sx/nj1000sx2.jpg" >
                                <img src="nj1000sx/nj1000sx3.jpg"style="height: 350px;" >

                        
                            </div>
                            <div class="details col-md-6">
                                <a  >
                                    <img src="image/ninja-1000sx.png" style=" width: 1px " ;alt="KLX 110 R">
                                    <h4>MỚI 2023</h4>
                                    <h3>NINJA® 1000SX</h3>
                                ...
                                <ul class="product-details">
                                    <li><strong>Loại</strong> 4 xi-lanh thẳng hàng, làm mát bằng dung dịch</li>
                                    <li><strong>Dung tích</strong> 1,043cc</li>
                                    <li><strong>Công suất cực đại</strong> 142 mã lực (105 kW) tại 10,000 vòng/phút</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 111 Nm tại 8,000 vòng/phút</li>
                                    <li><strong>Hệ thống nhiên liệu</strong> Phun xăng điện tử (FI), hệ thống điều khiển động cơ ECU</li>
                                    <li><strong>Hộp số</strong> 6 số, ly hợp chống trượt</li>
                                    <li><strong>Truyền động</strong> Dây xích</li>
                                </ul>
                                
                                <h5>Kích thước & trọng lượng</h5>
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,090 mm x 800 mm x 1,135 mm</li>
                                    <li><strong>Chiều cao yên</strong> 820 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 140 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 238 kg</li>
                                    <li><strong>Dung tích bình xăng</strong> 19 lít</li>
                                </ul>
                                
                                <h5>Khung gầm & hệ thống treo</h5>
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung ống thép kiểu trellis</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc USD 41 mm, điều chỉnh chiều cao và tải trọng</li>
                                    <li><strong>Hệ thống treo sau</strong> Phuộc mono-shock, điều chỉnh tải trọng</li>
                                    <li><strong>Phanh trước</strong> Đĩa đôi 300 mm, kẹp 4 piston</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 250 mm, kẹp piston đơn</li>
                                    <li><strong>ABS</strong> Có, hệ thống chống bó cứng phanh Bosch</li>
                                </ul>
