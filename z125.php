        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet7" id="frmsanphamchitiet7" method="post"></form>
                        
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="z125/z1251.jpg">
                                <img src="z125/z1252.jpg">
                                <img src="z125/z1253.jpg">

                            </div>
                            <div class="details col-md-6">
                                <a >
                                    <img src="image/z125-pro.png"style="width: 1px";alt="Z 500">
                                    <h4>2021</h4>
                                    <h3>Z125 PRO</h3>
                                ...
                                <ul class="product-details">
                                    <li><strong>Loại</strong> 1 xi-lanh, DOHC, làm mát bằng gió</li>
                                    <li><strong>Dung tích</strong> 125cc</li>
                                    <li><strong>Công suất cực đại</strong> 15 mã lực (11 kW) tại 10,000 vòng/phút</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 10.5 Nm tại 8,000 vòng/phút</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 1,930 x 750 x 1,050 mm</li>
                                    <li><strong>Chiều cao yên</strong> 785 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 150 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 135 kg</li>
                                    <li><strong>Dung tích bình xăng</strong> 11 lít</li>
                                </ul>
                                
                                <h5>Khung gầm & hệ thống treo</h5>
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung thép ống, chắc chắn</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc ống lồng, đường kính 33mm</li>
                                    <li><strong>Hệ thống treo sau</strong> Giảm xóc monoshock, điều chỉnh được</li>
                                    <li><strong>Phanh trước</strong> Đĩa đơn 200mm</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 190mm</li>
