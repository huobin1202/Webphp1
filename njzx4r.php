        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet3" id="frmsanphamchitiet3" method="post"></form>
                        
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="njzx4r/njzx4r1.jpg" >
                                <img src="njzx4r/njzx4r2.jpg" >
                                <img src="njzx4r/njzx4r3.jpg" style="height: 400px;">

                            </div>
                            <div class="details col-md-6">
                                <a>
                                    <img src="image/ninja-zx4r.png" style=" width: 1px " ;alt="KLX 110 R">
                                ...
                                <ul class="product-details">
                                    ...
                                    <li><strong>Dung tích</strong> 399cc</li>
                                    <li><strong>Công suất cực đại</strong> 80 mã lực (59.5 kW) tại 14,500 vòng/phút</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 39 Nm tại 13,000 vòng/phút</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 1,990 mm x 765 mm x 1,105 mm</li>
                                    <li><strong>Chiều cao yên</strong> 800 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 140 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 188 kg</li>
                                    <li><strong>Dung tích bình xăng</strong> 15 lít</li>
                                </ul>
                                
                                <h5>Khung gầm & hệ thống treo</h5>
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung thép dạng trellis</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc hành trình ngược 41mm (USD)</li>
                                    <li><strong>Hệ thống treo sau</strong> Phuộc mono-shock</li>
                                    <li><strong>Phanh trước</strong> Đĩa đôi 290 mm, kẹp piston đôi</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 220 mm, kẹp piston đơn</li>
                                    <li><strong>ABS</strong> Hệ thống phanh chống bó cứng (ABS)</li>
                                </ul>
