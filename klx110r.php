        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet11" id="frmsanphamchitiet11" method="post"></form>
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="klx110r/k110r.jpg" >
                                <img src="klx110r/k110r3.jpg" >
                                <img src="klx110r/k110r2.jpg" >
                            </div>
                            
                            
                            <div class="details col-md-6" style="margin-top: 0px;">
                                
                                <div class="card page-2" >
                                    <img src="image/klx-110r.png" style="width:1px;height: 1px;" alt="Z 500">
                                ...
                                <ul class="product-details">
                                    ...
                                    <li><strong>Dung tích</strong> 112cc</li>
                                    <li><strong>Công suất cực đại</strong> 7.5 mã lực (5.6 kW) tại 7,500 vòng/phút</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 8 Nm tại 6,000 vòng/phút</li>
                                    <li><strong>Hệ thống nhiên liệu</strong> Phun xăng điện tử (EFI)</li>
                                    <li><strong>Hộp số</strong> 4 cấp, côn tay</li>
                                    <li><strong>Truyền động</strong> Dây xích</li>
                                </ul>
                                
                                <h5>Kích thước & trọng lượng</h5>
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 1,540 x 735 x 975 mm</li>
                                    <li><strong>Chiều cao yên</strong> 730 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 210 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 85 kg</li>
                                    <li><strong>Dung tích bình xăng</strong> 3.7 lít</li>
                                </ul>
                                
                                <h5>Khung gầm & hệ thống treo</h5>
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong>  Khung thép ống, chắc chắn và ổn định</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc ống lồng, đường kính 30mm</li>
                                    <li><strong>Hệ thống treo sau</strong> Giảm xóc monoshock có thể điều chỉnh</li>
                                    <li><strong>Phanh trước</strong> Đĩa đơn 220mm</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 110mm</li>
                                    <li><strong>ABS</strong> Không có</li>
                                </ul>     
