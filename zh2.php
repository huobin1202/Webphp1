        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet6" id="frmsanphamchitiet6" method="post"></form>
                        
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="zh2/zh21.jpg" style="height: 400px;">
                                <img src="zh2/zh22.png" >
                                <img src="zh2/zh23.jpg" >

                            </div>
                            <div class="details col-md-6">
                                <a >
                                    <img src="image/z-h2.png" style="width: 1px";alt="KLX 110 R">
                                ...
                                <ul class="product-details">
                                    <li><strong>Loại</strong> 4 xi-lanh thẳng hàng, DOHC, siêu nạp</li>
                                    <li><strong>Dung tích</strong> 998cc</li>
                                    <li><strong>Công suất cực đại</strong> 200 mã lực (147 kW) tại 11,000 vòng/phút</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 137 Nm tại 8,500 vòng/phút</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,090 x 800 x 1,150 mm</li>
                                    <li><strong>Chiều cao yên</strong> 835 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 130 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 239 kg</li>
                                    <li><strong>Dung tích bình xăng</strong> 19 lít</li>
                                </ul>
                                
                                <h5>Khung gầm & hệ thống treo</h5>
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung kim cương thép ống</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc hành trình ngược, điều chỉnh được, 43mm</li>
                                    <li><strong>Hệ thống treo sau</strong> Mono-shock, điều chỉnh được</li>
                                    <li><strong>Phanh trước</strong> Đĩa đôi 320mm, đĩa gió</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 260mm</li>
                                    <li><strong>ABS</strong> Có</li>
                                </ul>
