        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet" id="frmsanphamchitiet" method="post"></form>
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="nj650/nj6501.jpg" style="height: 400px;">
                                <img src="nj650/nj6502.jpg" class="img-fluid" alt="NINJA® 650">
                                <img src="nj650/nj6503.jpg" style="height: 400px;">

                            </div>
                            <div class="details col-md-6">
                                <a >
                                    <img src="image/ninja-650.png"  style=" width:1px " ; alt="KLX 110 R">
                                ...
                                <ul class="product-details">
                                    <li><strong>Loại</strong> 2 xi-lanh song song</li>
                                    <li><strong>Dung tích</strong> 649cc</li>
                                    <li><strong>Công suất cực đại</strong> 68 mã lực (50 kW) tại 8,000 vòng/phút</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 64 Nm tại 6,700 vòng/phút</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,085 mm x 740 mm x 1,135 mm</li>
                                    <li><strong>Chiều cao yên</strong> 790 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 140 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 193 kg</li>
                                    <li><strong>Dung tích bình xăng</strong> 15 lít</li>
                                </ul>
                                
                                <h5>Khung gầm & hệ thống treo</h5>
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung ống thép kiểu trellis</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc ống lồng đường kính 41 mm</li>
                                    <li><strong>Hệ thống treo sau</strong> Mono-shock với điều chỉnh tải trọng</li>
                                    <li><strong>Phanh trước</strong> Đĩa đôi 300 mm, kẹp 2 piston</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 220 mm, kẹp piston đơn</li>
                                    <li><strong>ABS</strong> Có, hệ thống chống bó cứng phanh</li>
                                </ul>
                                <section class="cart">
