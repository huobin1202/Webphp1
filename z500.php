        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet8" id="frmsanphamchitiet8" method="post"></form>
                        
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="z500/z5001.jpg"style="height:400px" >
                                <img src="z500/z5002.png" >
                                <img src="z500/z5003.avif" >
                            </div>
                            <div class="details col-md-6">
                                <a >
                                    <img src="image/z500.png"  style="width: 1px";alt="Z 500">
                                ...
                                <ul class="product-details">
                                    ...
                                    <li><strong>Dung tích</strong> 500cc</li>
                                    <li><strong>Công suất cực đại</strong> 49 mã lực (36 kW) tại 8,500 vòng/phút</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 46 Nm tại 7,000 vòng/phút</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,085 x 800 x 1,105 mm</li>
                                    <li><strong>Chiều cao yên</strong> 790 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 160 mm</li>
                                ...
                                <ul class="product-details">
                                    ...
                                    <li><strong>Hệ thống treo sau</strong> Giảm xóc monoshock, có thể điều chỉnh độ đàn hồi</li>
                                    <li><strong>Phanh trước</strong> Đĩa đơn 290mm, 2 pít-tông</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 220mm, 1 pít-tông</li>
                                    <li><strong>ABS</strong> Có, cho phanh an toàn hơn trong mọi tình huống</li>
                                </ul>
