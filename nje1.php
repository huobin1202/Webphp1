        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet5" id="frmsanphamchitiet5" method="post"></form>                            
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="nje1/nje11.webp" >
                                <img src="nje1/nje12.png" >

                                <img src="nje1/nje13.jpg" style="height: 400px;">

                            </div>
                            <div class="details col-md-6">
                                <a >
                                    <img src="image/ninja-e1.png" style=" width: 1px " ;alt="KLX 110 R">
                                ...
                                <ul class="product-details">
                                    <li><strong>Loại</strong> Động cơ điện một chiều (DC)</li>
                                    <li><strong>Công suất cực đại</strong> 100 mã lực (74.6 kW)</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 160 Nm</li>
                                    <li><strong>Hệ thống nhiên liệu</strong> Pin lithium-ion (LFP)</li>
                                    <li><strong>Hộp số</strong> Hộp số điện tử, không có cần số cơ học</li>
                                    <li><strong>Truyền động</strong> Truyền động trực tiếp (direct drive)</li>
                                    <li><strong>Phạm vi di chuyển</strong> Khoảng 300 km cho mỗi lần sạc đầy (tùy vào điều kiện lái)</li>
                                    <li><strong>Thời gian sạc</strong> 1.5 - 2 giờ (sạc nhanh)</li>
                                </ul>
                                
                                <h5>Kích thước & trọng lượng</h5>
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,070 mm x 770 mm x 1,120 mm</li>
                                    <li><strong>Chiều cao yên</strong> 820 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 130 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 235 kg</li>
                                    <li><strong>Dung tích bình xăng</strong> Không có (xe điện sử dụng pin)</li>
                                </ul>
                                
                                <h5>Khung gầm & hệ thống treo</h5>
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung hợp kim nhôm nhẹ, bền bỉ</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc 43 mm với khả năng điều chỉnh độ cứng</li>
                                    <li><strong>Hệ thống treo sau</strong> Phuộc đơn có thể điều chỉnh độ nén và độ hồi</li>
                                    <li><strong>Phanh trước</strong> Đĩa đôi 310 mm, trang bị hệ thống ABS chống bó cứng phanh</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 220 mm với ABS</li>
                                    <li><strong>ABS</strong> Hệ thống chống bó cứng phanh tiên tiến, an toàn</li>
                                </ul>
