        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet9" id="frmsanphamchitiet9" method="post"></form>
                        
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="z650/z6501.jpg"style="height:400px">
                                <img src="z650/z6502.jpg" >
                                <img src="z650/z6503.jpg" style="height:350px">
                            </div>
                            <div class="details col-md-6">
                                <a >
                                    <img src="image/z650rs.png" style="width: 1px";alt="Z 500">
                                ...
                                <ul class="product-details">
                                    <li><strong>Loại</strong> 2 xi-lanh, DOHC, làm mát bằng dung dịch</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,085 x 800 x 1,070 mm</li>
                                    <li><strong>Chiều cao yên</strong> 790 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 130 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 190 kg</li>
                                ...
                                <ul class="product-details">
                                    ...
                                    <li><strong>Hệ thống treo trước</strong> Phuộc ống lồng, đường kính 41mm</li>
                                    <li><strong>Hệ thống treo sau</strong> Giảm xóc monoshock có thể điều chỉnh</li>
                                    <li><strong>Phanh trước</strong> Đĩa đơn 300mm, 2 pít-tông</li>
