        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet15" id="frmsanphamchitiet15" method="post"></form>
                        
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="klx300/klx3001.jpg" >
                                <img src="klx300/klx3002.jpg" >
                                <img src="klx300/klx3003.webp"style="height:400px">
                            </div>
                            <div class="details col-md-6">
                                <div class="card page-3">
                                    <img src="image/klx-300.png" style="width: 1px;" alt="KLX 110 R">
                                ...
                                <ul class="product-details">
                                    ...
                                    <li><strong>ABS</strong> Không có (thiết kế cho off-road và địa hình khó)</li>
                                </ul>
