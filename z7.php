        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet10" id="frmsanphamchitiet10" method="post"></form>
                       
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="z7/z73.jpg" style="height: 350px;">
                                <img src="z7/z71.webp" >
                                <img src="z7/z72.jpg"style="height: 350px;" >
                               
                            </div>
                            <div class="details col-md-6">
                                <a >
                                    <img src="image/z7-hybrid.png" style="width: 1px";alt="Z 500">
                                ...
                                <ul class="product-details">
                                    <li><strong>Loại</strong> 2 xi-lanh, DOHC, làm mát bằng dung dịch, Hybrid</li>
                                    <li><strong>Dung tích</strong> 750cc</li>
                                    <li><strong>Công suất cực đại</strong> 100 mã lực (75 kW) tại 9,000 vòng/phút</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 80 Nm tại 7,500 vòng/phút</li>
                                    <li><strong>Hệ thống nhiên liệu</strong> Phun xăng điện tử (EFI) kết hợp với động cơ điện</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,150 x 800 x 1,130 mm</li>
                                    <li><strong>Chiều cao yên</strong> 800 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 150 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 210 kg</li>
                                    <li><strong>Dung tích bình xăng</strong> 17 lít</li>
                                </ul>
                                
                                <h5>Khung gầm & hệ thống treo</h5>
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung thép ống, cứng cáp và ổn định</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc ống lồng, đường kính 43mm</li>
                                    <li><strong>Hệ thống treo sau</strong> Giảm xóc monoshock có thể điều chỉnh</li>
                                    <li><strong>Phanh trước</strong> Đĩa đôi 320mm, 2 pít-tông</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 220mm, 1 pít-tông</li>
                                    <li><strong>ABS</strong> Có, giúp tăng cường khả năng kiểm soát khi phanh</li>
                                </ul>
