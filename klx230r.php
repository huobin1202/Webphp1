        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet13" id="frmsanphamchitiet13" method="post"></form>
                        
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="klx230r/klx230r1.jpg" style="height:420px">
                                <img src="klx230r/klx230r2.jpg"style="height:400px">
                                <img src="klx230r/klx230r3.jpg"style="height:400px">                            </div>

                            <div class="details col-md-6">
                                <div class="card page-3">
                                    <img src="image/klx-230r.png"style="width:1px" alt="KLX 110 R">
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,105 x 825 x 1,230 mm</li>
                                    <li><strong>Chiều cao yên</strong> 895 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 300 mm</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung thép ống với khả năng chịu lực cao</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc ống lồng đường kính 37mm có hành trình 240mm</li>
                                    <li><strong>Hệ thống treo sau</strong> Giảm xóc monoshock có thể điều chỉnh hành trình 260mm</li>
                                    <li><strong>Phanh trước</strong> Đĩa đơn 240mm, kiểu lót sợi</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 220mm</li>
                                    <li><strong>ABS</strong> Không có (thiết kế cho off-road)</li>
                                </ul>
                                <section class="cart">
