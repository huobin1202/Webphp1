        ...
        <div class="container mt-4">
            <div class="card">
                <div class="container-fliud">
                    <form name="frmsanphamchitiet16" id="frmsanphamchitiet16" method="post"></form>
                        
                        <div class="wrapper row">
                            <div class="preview col-md-6">
                                <img src="klx300sm/klx300sm1.webp"style="height:400px">
                                <img src="klx300sm/klx300sm2.jpg" style="height:400px">
                                <img src="klx300sm/klx300sm3.webp" >

                            </div>
                            <div class="details col-md-6" >
                                <div class="card page-3">
                                    <img src="image/klx-300sm.png" style="width: 1px"alt="KLX 110 R">
                                ...
                                <ul class="product-details">
                                    <li><strong>Loại</strong> 4 thì, 1 xi-lanh, làm mát bằng dung dịch</li>
                                    <li><strong>Dung tích</strong> 292cc</li>
                                    <li><strong>Công suất cực đại</strong> 27.3 mã lực (20.4 kW) tại 8,000 vòng/phút</li>
                                    <li><strong>Mô-men xoắn cực đại</strong> 26.5 Nm tại 6,500 vòng/phút</li>
                                ...
                                <ul class="product-details">
                                    <li><strong>Chiều dài x rộng x cao</strong> 2,140 x 825 x 1,170 mm</li>
                                    <li><strong>Chiều cao yên</strong> 875 mm</li>
                                    <li><strong>Khoảng sáng gầm xe</strong> 295 mm</li>
                                    <li><strong>Trọng lượng ướt</strong> 142 kg</li>
                                    <li><strong>Dung tích bình xăng</strong> 7.7 lít</li>
                                </ul>
                                
                                <h5>Khung gầm & hệ thống treo</h5>
                                <ul class="product-details">
                                    <li><strong>Khung xe</strong> Khung thép ống chịu lực cao</li>
                                    <li><strong>Hệ thống treo trước</strong> Phuộc ống lồng đường kính 43mm, hành trình 300mm</li>
                                    <li><strong>Hệ thống treo sau</strong> Giảm xóc monoshock, hành trình 300mm</li>
                                    <li><strong>Phanh trước</strong> Đĩa đơn 250mm</li>
                                    <li><strong>Phanh sau</strong> Đĩa đơn 240mm</li>
                                    <li><strong>ABS</strong> Không có (thiết kế cho off-road và đường phố)</li>
                                </ul>
